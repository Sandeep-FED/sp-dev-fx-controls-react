...
import { TestImagePickerControl } from './TestImagePickerControl';
import { TestUserPickerControl } from './TestUserPickerControl';
    ...
    return (
      <div className={styles.controlsTest}>
        <div className={styles.container}>
          ...
          <ListItemAttachments
            listId="e7a3ef63-70f6-4cc1-b95c-1f9eb8af2c8c"
        ...
        <div
          id="TestUserPickerControlDiv"
          className={styles.container}
          hidden={!controlVisibility.TestUserPickerControl}
        >
          <TestUserPickerControl
            context={this.props.context}
            themeVariant={this.props.themeVariant}
          />
        </div>
        ...
        <div
          id="TestCalendarControlDiv"
          className={styles.container}
          hidden={!controlVisibility.TestCalendarControl}
        >
          <TestCalendarControl
            context={this.props.context}
        ...
        {/* Test Image Picker Control */}
        <div
          id="TestImagePickerDiv"
          className={styles.container}
          hidden={!controlVisibility.TestImagePickerControl}
        >
          <TestImagePickerControl
            context={this.props.context}
            themeVariant={this.props.themeVariant}
          />
        </div>
