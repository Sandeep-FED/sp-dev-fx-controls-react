...
const TestCalendarControl = React.lazy(() => import('./TestCalendarControl').then(module => ({ default: module.TestCalendarControl })));
const TestImagePickerControl = React.lazy(() => import('./TestImagePickerControl').then(module => ({ default: module.TestImagePickerControl })));
const TestUserPickerControl = React.lazy(() => import('./TestUserPickerControl').then(module => ({ default: module.TestUserPickerControl })));
      ...
      <React.Suspense fallback={<div>Loading...</div>}>
        <div className={styles.controlsTest}>
          ...
          {controlVisibility.Calendar &&
            <div id="TestCalendarControlDiv" className={styles.container}>
              <TestCalendarControl   theme={this.props.themeVariant as any} context={this.props.context} hasTeamsContext={false} themeString={'default'} title={'Calendar'} appHostName={EAppHostName.SharePoint}  />
            </div>
          }
          ...
          {controlVisibility.UserPicker &&
            <div id="TestUserPickerControl" className={styles.container}>
              <TestUserPickerControl context={this.props.context} themeVariant={this.props.themeVariant} />
            </div>
          }
          {controlVisibility.ImagePicker &&
            <div id="TestImagePickerControl" className={styles.container}>
              <TestImagePickerControl context={this.props.context} themeVariant={this.props.themeVariant} />
            </div>
          }
        </div>
      </React.Suspense>
