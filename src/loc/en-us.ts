...
define([], () => {
  return {
    ...
    CreativeCommonsMessage:
      "These results are tagged with Creative Commons licenses. Review the licenses to ensure you comply.",
    ...
    OneDriveEmptyFolderDescription:
      "To add files, go to your OneDrive. You can also add files to this folder using the OneDrive app for your computer.",
    ...
    SizeUnit: ["bytes", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"],
    ...
    ImagePickderSelectLabel: "Select image",
    ImagePickerDeleteImageLabel: "Delete",
    ImagePickerSelectLabel: "Select",
    ImagePickerCancelLabel: "Cancel",
    ImagePickerPanelHeaderText: "Please select an image to use as a thumbnail",
    ImagePickerSharePointTabLabel: "SharePoint",
    ImagePickerOneDriveTabLabel: "OnDrive",
    ImagePickerStockImagesTabLabel: "Stock Images",
    ImagePickerUploadTabLabel: "Upload",
    ImagePickerDragFilesAccpted: "Accepted file types: .gif, .jpg, .jpeg, .png, .svg",
    ImagePickerDragFilesRejected: "Some files will be rejected",
    ImagePickerDragFilesActive:"Drop Images here...",
    ImagePickerDragDropText: "Drag 'n' drop image files or click to select files, max files to upload in one go is 10",
    ImagePickerUploadLocationLabel: "Select upload location",
    ImagePickerUploadLocationOndriveLabel: "OnDrive",
    ImagePickerUploadLocationSharePointLabel: "Current Site",
